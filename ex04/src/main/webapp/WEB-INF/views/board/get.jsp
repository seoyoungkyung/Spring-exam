	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<button data-oper="modify" class="btn btn-dafult">Modify</button>
		...
		function showList(page){
			replyService.getList(
				...
				for (let i=0,len=list.list.length || 0; i<len; i++){
					...
					str += "<strong class='primary-font'>"+list.list[i].replyer+"</strong>";
					str += "<small class='pull-right text-muted'>"+replyService.displayTime(list.list[i].replyDate)+"</small>";
					str += "</div>";
					str += "<p>"+list.list[i].reply+"</p>";
					str += "</li>";
